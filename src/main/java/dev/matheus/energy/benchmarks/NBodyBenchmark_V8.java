...
/**
 * NBody benchmark variant #8 from the Computer Language Benchmarks Game.
 * Naive transliteration from Michael Ferguson's Chapel program.
 * 
 * Source: benchmarksgame/nbody/nbody.java-8.java
 * Contributed by Isaac Gouy
 */
public class NBodyBenchmark_V8 implements BenchmarkAlgorithm {
    ...
    public String getDescription() {
        return "N-body simulation (naive variant 8)";
    }
