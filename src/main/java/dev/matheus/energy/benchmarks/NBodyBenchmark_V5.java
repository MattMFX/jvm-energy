...
/**
 * NBody benchmark variant #5 from the Computer Language Benchmarks Game.
 * Contributed by Mark C. Lewis, uses double[] instead of Object[] by Han Kai.
 * 
 * Source: benchmarksgame/nbody/nbody.java-5.java
 */
public class NBodyBenchmark_V5 implements BenchmarkAlgorithm {
    ...
    public String getDescription() {
        return "N-body simulation (optimized array variant 5)";
    }
    ...
    public Object execute(int n) throws Exception {
        ...
        return new double[]{initialEnergy, finalEnergy};
    }
