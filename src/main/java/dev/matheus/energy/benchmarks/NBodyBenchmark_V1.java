...
/**
 * N-Body simulation benchmark from the Computer Language Benchmarks Game.
 * Simulates the orbits of Jovian planets using Newtonian physics.
 * 
...
public class NBodyBenchmark_V1 implements BenchmarkAlgorithm {
    ...
    public String getDescription() {
        return "N-Body simulation of Jovian planets";
    }
    ...
    private static final class NBodySystem {
